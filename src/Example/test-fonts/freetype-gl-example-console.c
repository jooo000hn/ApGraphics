...
console_new( void )
{
    ...
    markup_t normal;
    normal.family  = "../media/fonts/VeraMono.ttf";
    normal.size    = 13.0;
    normal.bold    = 0;
    normal.italic  = 0;
    normal.rise    = 0.0;
    ...
    normal.font = texture_font_new_from_file( atlas, 13, "../media/fonts/VeraMono.ttf" );

    markup_t bold = normal;
    bold.bold = 1;
    bold.font = texture_font_new_from_file( atlas, 13, "../media/fonts/VeraMoBd.ttf" );

    markup_t italic = normal;
    italic.italic = 1;
    bold.font = texture_font_new_from_file( atlas, 13, "../media/fonts/VeraMoIt.ttf" );

    markup_t bold_italic = normal;
    bold.bold = 1;
    italic.italic = 1;
    italic.font = texture_font_new_from_file( atlas, 13, "../media/fonts/VeraMoBI.ttf" );
