...
build_buffer( void )
{
    ...
    if( p_family == VERA)
    {
        font = texture_font_new_from_file( atlas, p_size, "../media/fonts/Vera.ttf" );
    }													  
    else if( p_family == VERA_MONO)						  
    {													  
        font = texture_font_new_from_file( atlas, p_size, "../media/fonts/VeraMono.ttf" );
    }													  
    else if( p_family == LUCKIEST_GUY)					  
    {													  
        font = texture_font_new_from_file( atlas, p_size, "../media/fonts/LuckiestGuy.ttf" );
    }													   
    else if( p_family == SOURCE_SANS )					   
    {													   
        font = texture_font_new_from_file( atlas, p_size, "../media/fonts/SourceSansPro-Regular.ttf" );
    }													  
    else if( p_family == SOURCE_CODE )					  
    {													  
        font = texture_font_new_from_file( atlas, p_size, "../media/fonts/SourceCodePro-Regular.ttf" );
    }													   
    else if( p_family == OLD_STANDARD )					   
    {													   
        font = texture_font_new_from_file( atlas, p_size, "../media/fonts/OldStandard-Regular.ttf" );
    }													  
    else if( p_family == LOBSTER )						  
    {													  
        font = texture_font_new_from_file( atlas, p_size, "../media/fonts/Lobster-Regular.ttf" );
    }
    else
    {
