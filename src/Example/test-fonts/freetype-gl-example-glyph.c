...
void init( void )
{
    ...
    texture_font_t * big = texture_font_new_from_file( atlas, 400, "../media/fonts/Vera.ttf");
    texture_font_t * small = texture_font_new_from_file( atlas, 18, "../media/fonts/Vera.ttf");
    texture_font_t * title = texture_font_new_from_file( atlas, 32, "../media/fonts/Vera.ttf");
    ...
    text_shader = shader_load( "../media/shaders/v3f-t2f-c4f.vert",
