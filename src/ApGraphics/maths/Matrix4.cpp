...
namespace apanoo {
	...
	Matrix4 Matrix4::Scale(const Vector3& r)
	{
		for (unsigned int i = 0; i < 4; i++)
		{
			for (unsigned int j = 0; j < 4; j++)
	...
	Matrix4 Matrix4::Translation(const Vector3& r)
	{
		for (unsigned int i = 0; i < 4; i++)
		{
			for (unsigned int j = 0; j < 4; j++)
	...
	Matrix4 Matrix4::RotationEuler(float rotateX, float rotateY, float rotateZ)
	{
		Matrix4 rx, ry, rz;
	...
	Matrix4 Matrix4::RotationFromVectors(const Vector3& n, const Vector3& v, const Vector3& u)
	{
	...
	Matrix4 Matrix4::RotationFromDirection(const Vector3& forward, const Vector3& up)
	{
